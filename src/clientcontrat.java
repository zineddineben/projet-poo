...
public class clientcontrat {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					clientcontrat window = new clientcontrat();
	...
	private void initialize() {
		...
		lblAppointmentRequests.setFont(new Font("Uni Sans Heavy CAPS", Font.BOLD, 64));
		lblAppointmentRequests.setBackground(new Color(50, 72, 81));
		lblAppointmentRequests.setBounds(0, 0, 920, 97);
